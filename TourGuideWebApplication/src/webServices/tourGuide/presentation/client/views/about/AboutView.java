package webServices.tourGuide.presentation.client.views.about;
...
public class AboutView extends Composite implements ErrorPresenter.Display{
	...
	interface MapViewUiBinder extends UiBinder<Widget, AboutView> {
	}
