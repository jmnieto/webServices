...
public interface IResourcesUsers {
     ...
     * @param role
     *            Role of the user on the application. The use of the
     *            administration functions will depend on the user role.
     ...
     * 
     * @param user
     *            User that it is wanted to save.
     ...
     * 
     * @param user
     *            User that it is desired to delete.
     */
    ...
    /**
     * An user which has a username equal to the parameter nameUser will be
     * returned.
     * 
     * @param nameUser
     *            Name of the user that it is wanted to look for.
     * @return It will be returned either a instance of the user which has an
     *         username equal to the parameter nameUser or NULL if there is any
     *         user with nameUser as its username.
     */
    ...
    /**
     * Given an username, it is checked out if there is some user with this
     * username.
     * 
     * @param nameUser
     *            Username to check out.
     * @return Either True if there is an user with this username or False if
     *         not
     */
